...
export default function EmptyState({ onNew }) {
  return (
    <div className="flex flex-col items-center gap-4 py-20">
      ...
      <button
        onClick={onNew}
        className="flex items-center gap-2 rounded-lg border border-sky-600/40 bg-sky-600/20 px-4 py-2 text-sm font-semibold text-sky-200 hover:bg-sky-600/30 transition"
      >
